...
//presente tt les info finale qui iront dans l'etiquette
@Entity
...
public class LabelContent extends BaseEntity {
    ...
    // Les snapshots preservent la verite source au moment de la generation.
    @OneToMany(mappedBy = "labelContent", cascade = jakarta.persistence.CascadeType.ALL, orphanRemoval = true, fetch = FetchType.EAGER)
